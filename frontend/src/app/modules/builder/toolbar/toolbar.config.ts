...
export const ELEMENT_TYPE_VS_TOOLBAR_OPT = {
  ...
  [ELEMENT_TYPES.PHOTO]: [ATO.OPACITY, ATO.DELETE, ATO.LOCK, ATO.DUPLICATE, ATO.FLIP_HORIZONTAL, ATO.FLIP_VERTICAL],
  [ELEMENT_TYPES.VECTOR]: [ATO.BACKGROUND_COLOR, ATO.OPACITY, ATO.DELETE, ATO.LOCK, ATO.DUPLICATE, ATO.FLIP_HORIZONTAL, ATO.FLIP_VERTICAL],

  [ELEMENT_TYPES.TEXT]: [ATO.BACKGROUND_COLOR, ATO.FONT_FAMILY, ATO.COLOR, ATO.FONT_SIZE, ATO.OPACITY, ATO.LETTER_SPACING,
  ATO.FONT_WEIGHT_BOLD, ATO.FONT_STYLE_ITALIC, ATO.DELETE, ATO.TEXT_ALIGNMENT, ATO.LOCK, ATO.DUPLICATE],

  [ELEMENT_TYPES.MULTIPLE_SELECTION]: [ATO.BACKGROUND_COLOR, ATO.FONT_FAMILY, ATO.FONT_SIZE, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.LOCK,
  ATO.DUPLICATE],
  [ELEMENT_TYPES.GROUP]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE, ATO.LOCK, ATO.GROUP_UNGROUP],
  [ELEMENT_TYPES.LINE]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE, ATO.LOCK, ATO.GROUP_UNGROUP],
};
