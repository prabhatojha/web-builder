...
export const ELEMENT_TYPE_VS_TOOLBAR_OPT = {
  ...
  [ELEMENT_TYPES.MULTIPLE_SELECTION]: [ATO.FONT_FAMILY, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE],
  [ELEMENT_TYPES.GROUP]: [ATO.FONT_FAMILY, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE, ATO.GROUP_UNGROUP],
  [ELEMENT_TYPES.LINE]: [ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE, ATO.GROUP_UNGROUP],
};
