...
export const ELEMENT_TYPE_VS_TOOLBAR_OPT = {
  ...
  [ELEMENT_TYPES.MULTIPLE_SELECTION]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE],
  [ELEMENT_TYPES.GROUP]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE, ATO.GROUP_UNGROUP],
  [ELEMENT_TYPES.LINE]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.OPACITY, ATO.DELETE, ATO.DUPLICATE, ATO.GROUP_UNGROUP],
};
