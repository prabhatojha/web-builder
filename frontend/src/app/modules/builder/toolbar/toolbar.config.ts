...
export const ELEMENT_TYPE_VS_TOOLBAR_OPT = {
  ...
  [ELEMENT_TYPES.PHOTO]: [ATO.DELETE, ATO.LOCK, ATO.DUPLICATE, ATO.FLIP_HORIZONTAL, ATO.FLIP_VERTICAL, ATO.LAYERING],
  [ELEMENT_TYPES.VECTOR]: [ATO.BACKGROUND_COLOR, ATO.DELETE, ATO.LOCK, ATO.DUPLICATE,
  ATO.FLIP_HORIZONTAL, ATO.FLIP_VERTICAL, ATO.LAYERING],

  [ELEMENT_TYPES.TEXT]: [ATO.BACKGROUND_COLOR, ATO.FONT_FAMILY, ATO.COLOR, ATO.FONT_SIZE, ATO.LETTER_SPACING,
  ATO.FONT_WEIGHT_BOLD, ATO.FONT_STYLE_ITALIC, ATO.DELETE, ATO.TEXT_ALIGNMENT, ATO.LOCK, ATO.DUPLICATE, ATO.LAYERING],

  [ELEMENT_TYPES.MULTIPLE_SELECTION]: [ATO.BACKGROUND_COLOR, ATO.FONT_FAMILY, ATO.FONT_SIZE, ATO.COLOR, ATO.DELETE, ATO.LOCK,
  ATO.DUPLICATE],
  [ELEMENT_TYPES.GROUP]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.DELETE, ATO.DUPLICATE, ATO.LOCK, ATO.GROUP_UNGROUP,
  ATO.LAYERING],
  [ELEMENT_TYPES.LINE]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.DELETE, ATO.DUPLICATE, ATO.LOCK, ATO.GROUP_UNGROUP,
  ATO.LAYERING, ATO.LINE_WIDTH],
  [ELEMENT_TYPES.BOX]: [ATO.BACKGROUND_COLOR, ATO.COLOR, ATO.DELETE, ATO.DUPLICATE, ATO.LOCK, ATO.GROUP_UNGROUP,
  ATO.LAYERING],
};
